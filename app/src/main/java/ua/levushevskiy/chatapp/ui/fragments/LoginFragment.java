...
import ua.levushevskiy.chatapp.core.login.LoginContract;
import ua.levushevskiy.chatapp.core.login.LoginPresenter;
import ua.levushevskiy.chatapp.ui.activities.RegisterActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void setDummyCredentials() {
        mETxtEmail.setText("E-mail");
        mETxtPassword.setText("Password");
    }
